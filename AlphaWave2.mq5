...
//+------------------------------------------------------------------+
string CheckOpenBuysSells() {
   int buy_count = 0;
   int sell_count = 0;
   string commentText = "No Checks Yet";
   ...
   for(int i = PositionsTotal()-1; i >=0; i--)
     {
      ...
      if(buy_count > sell_count)
       {
            commentText = "More Buys than sells";
       }
       else if(sell_count > buy_count)
         {
            commentText = "More sells than Buys";
         }
         else
         {
            commentText = "Equal sells and buys open";
         }
